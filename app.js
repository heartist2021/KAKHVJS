...
function playRound(playerSelection, computerSelection) {
  ...
  if (computerSelection == playerSelection) {
    ...
    (computerSelection == "KAMAL" && playerSelection == "VJS") ||
    (computerSelection == "VJS" && playerSelection == "KALAI") ||
    (computerSelection == "KALAI" && playerSelection == "KAMAL")
  ) {
